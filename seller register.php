...
<body>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="text-align: right;">
                    <a href="sellerindex.html">Home</a>&nbsp
                    &nbsp<a href="loginseller.php">Login</a>
                </td>
            </tr>
        </table>
    </div>
    <div name="content" id="content" style="height: 560px;">
        ...
        <form name="registerfrm" id="registerfrm" action="seller registerhandler.php" method="get">
            <table align="center" border="1" style="border-collapse: collapse;">
                <tr>
                    <th colspan="2" style="font-size: xx-large;"> Seller Register
                </tr>
                <tr>
                    <td>Name</td>
